...
public class GoldMedalController {
    ...
    private CountryDetailsResponse getCountryDetailsResponse(String countryName) {
        ...
        var winterWins = goldMedalRepository.getByCountryAndSeasonOrderByYearAsc(countryName, "summer") ;// TODO: get the collection of wins at the Winter Olympics
    ...
    private List<CountrySummary> getCountrySummaries(String sortBy, boolean ascendingOrder) {
        ...
        switch (sortBy) {
            case "name":
                ...
                break;
            case "gdp":
                countries = ascendingOrder ? countryRepository.getAllByOrderByGdpAsc() : countryRepository.getAllByOrderByNameDesc(); // TODO: list of countries sorted by gdp in the given order
                break;
            case "population":
